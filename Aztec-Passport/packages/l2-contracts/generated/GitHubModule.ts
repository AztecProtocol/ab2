...
import GitHubModuleContractArtifactJson from '../target/github_module-GitHubModule.json' assert { type: 'json' };
export const GitHubModuleContractArtifact = loadContractArtifact(GitHubModuleContractArtifactJson as NoirCompiledContract);
...
export class GitHubModuleContract extends ContractBase {
  ...
  public static async at(
    ...
    return Contract.at(address, GitHubModuleContract.artifact, wallet) as Promise<GitHubModuleContract>;
  }
  ...
  public static deploy(wallet: Wallet, _admin: AztecAddressLike) {
    return new DeployMethod<GitHubModuleContract>(Fr.ZERO, wallet, GitHubModuleContractArtifact, GitHubModuleContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeysHash(publicKeysHash: Fr, wallet: Wallet, _admin: AztecAddressLike) {
    return new DeployMethod<GitHubModuleContract>(publicKeysHash, wallet, GitHubModuleContractArtifact, GitHubModuleContract.at, Array.from(arguments).slice(2));
  }
...
ValueNote: {
  ...
  public declare methods: {
    ...
    verify: ((address: AztecAddressLike, header_array: (bigint | number)[], pubkey_modulus: FieldLike[], pubkey_redc: FieldLike[], signature: FieldLike[], from_header_sequence_index: (bigint | number), from_header_sequence_length: (bigint | number), from_address_sequence_index: (bigint | number), from_address_sequence_length: (bigint | number), to_header_sequence_index: (bigint | number), to_header_sequence_length: (bigint | number), to_address_sequence_index: (bigint | number), to_address_sequence_length: (bigint | number), email_array: (bigint | number)[]) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
  };
