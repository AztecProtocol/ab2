...
import LinkedinModuleContractArtifactJson from './target/linkedin_module-LinkedinModule.json';

export const LinkedinModuleContractArtifact = loadContractArtifact(
  LinkedinModuleContractArtifactJson as unknown as NoirCompiledContract
);
...
export class LinkedinModuleContract extends ContractBase {
  ...
  public static async at(address: AztecAddress, wallet: Wallet) {
    return Contract.at(
      address,
      LinkedinModuleContract.artifact,
      wallet
    ) as Promise<LinkedinModuleContract>;
  }
  ...
  public static deployWithOpts<
    M extends keyof LinkedinModuleContract['methods'],
  >(
