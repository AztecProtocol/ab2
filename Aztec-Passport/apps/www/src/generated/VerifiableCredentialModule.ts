...
import VerifiableCredentialModuleContractArtifactJson from './target/vc_module-VerifiableCredentialModule.json';

export const VerifiableCredentialModuleContractArtifact = loadContractArtifact(
  VerifiableCredentialModuleContractArtifactJson as unknown as NoirCompiledContract
);
...
export class VerifiableCredentialModuleContract extends ContractBase {
  ...
  public static async at(address: AztecAddress, wallet: Wallet) {
    return Contract.at(
      address,
      VerifiableCredentialModuleContract.artifact,
      wallet
    ) as Promise<VerifiableCredentialModuleContract>;
  }
  ...
  public static deployWithOpts<
    M extends keyof VerifiableCredentialModuleContract['methods'],
  >(
  ...
  public static get storage(): ContractStorageLayout<
    'admin' | 'jwt_registry' | 'passport_address'
  > {
    return {
      admin: {
        slot: new Fr(1),
  ...
  public declare methods: {
    ...
    /** get_jwt_registry() */
    get_jwt_registry: (() => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
